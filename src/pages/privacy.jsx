...
function Privacy() {
    return (
        <div className="mx-auto lg:!px-20 !px-10 !py-20">
            ...
            <p className="text-center !mb-8"><strong>Last updated: September 09, 2025</strong></p>
            ...
            <section className="!mb-8">
                ...
                <p>
                    ...
                    Privacy Policy has been created with the help of the<span className="font-semibold text-blue-600"> Privacy Policy Generator</span>.
                </p>
            </section>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Collecting and Using Your Personal Data</h2>
                ...
                <h4 className="font-semibold  !mb-2 !mt-5">Usage Data</h4>
                ...
                <h3 className="text-lg font-semibold !mb-3 !mt-5">Tracking Technologies and Cookies</h3>
                <p>
                ...
                <p className="!mt-3">
                    ...
                    as soon as You close Your web browser. You can learn more about cookies on <span className="font-semibold text-blue-600">TermsFeed
                    website</span>  article.
                </p>
                
                <p className="!mt-3">We use both Session and Persistent Cookies for the purposes set out below:</p>
                
                <h4 className="font-semibold !mb-2 !mt-5">Necessary / Essential Cookies</h4>
                <ul className="list-disc list-inside !space-y-2 lg:!px-10">
                ...
                <h4 className="font-semibold !mb-2 !mt-5">Cookies Policy / Notice Acceptance Cookies</h4>
                <ul className="list-disc list-inside !space-y-2 lg:!px-10">
                ...
                <h4 className="font-semibold !mb-2 !mt-5">Functionality Cookies</h4>
                <ul className="list-disc list-inside !space-y-2 lg:!px-10">
                    <li><strong>Type:</strong> Persistent Cookies</li>
                    <li><strong>Administered by:</strong> Us</li>
                    <li>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Use of Your Personal Data</h2>
                ...
                <ul className="list-disc list-inside !space-y-2 lg:!px-10 !mt-3">
                    ...
                    <li><strong>To manage Your requests:</strong> To manage Your requests: To attend and manage Your requests to Us.</li>
                    <li>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Retention of Your Personal Data</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Transfer of Your Personal Data</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Delete Your Personal Data</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Disclosure of Your Personal Data</h2>
                
                <h3 className="text-lg font-semibold !mb-3">Business Transactions</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold !mb-3 !mt-5">Law enforcement</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold !mb-3 !mt-5">Other legal requirements</h3>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Security of Your Personal Data</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Children's Privacy</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Changes to this Privacy Policy</h2>
                <p>
