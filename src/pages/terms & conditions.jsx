...
function Terms() {
  return (
    <div className="mx-auto lg:!px-20 !px-10 !py-20">
      ...
      <p className="!mb-8">
        Any dispute taken into consideration could and would be soughted by law
        of the respective Country through mutual Arbitration.
      </p>
      ...
      <section className="!mb-8">
        ...
        <ul className="list-disc list-inside !space-y-2 lg:!px-10 !mt-3">
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to DEVAVRATHA CONSULTANCY
            SERVICES (OPC) PRIVATE LIMITED, NO2739 1ST RUDRAGUPPE Kandangala
            Kodagu Karnataka India 571218.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to devavratha consultancy,
            accessible from devarathaconsultancy.com
          </li>
          <li>
      ...
      <section className="!mb-8">
        ...
        <ul className="list-disc list-inside space-y-2 lg:!px-10 !mt-3">
          <a href="mailto:www.devavrathaconsultancy@gmail.com">
