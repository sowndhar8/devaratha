...
function Terms() {
    return (
        <div className="mx-auto lg:!px-20 !px-10 !py-20">
            <h1 className="lg:text-5xl md:text-4xl text-3xl font-bold text-center !mb-8">
                Terms & Conditions
            </h1>
            <p className="text-center !mb-8">
                <strong>Last updated: September 09, 2025</strong>
            </p>
            ...
            <p className="!mb-8">Any dispute taken into consideration  could and would be soughted by law of the respective Country through mutual Arbitration.</p>

            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Interpretation and Definitions</h2>
                ...
                <h3 className="text-lg font-semibold !mb-3 !mt-5">Definitions</h3>
                <p>For the purposes of these Terms and Conditions:</p>
                <ul className="list-disc list-inside !space-y-2 lg:!px-10 !mt-3">
                    <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                    <li><strong>Country</strong> refers to: Karnataka, India</li>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to DEVAVRATHA CONSULTANCY SERVICES (OPC) PRIVATE LIMITED, NO2739 1ST RUDRAGUPPE Kandangala Kodagu Karnataka India 571218.</li>
                    <li><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
                    <li><strong>Service</strong> refers to the Website.</li>
                    <li><strong>Terms and Conditions</strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the<span className="font-semibold text-blue-600"> Terms and Conditions Generator.</span></li>
                    <li><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</li>
                    <li><strong>Website</strong> refers to devavratha consultancy, accessible from devarathaconsultancy.com</li>
                    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                </ul>
            </section>

            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Acknowledgment</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Links to Other Websites</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Termination</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Disputes Resolution</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Severability and Waiver</h2>
                ...
                <h3 className="text-lg font-semibold !mb-3 !mt-5">Waiver</h3>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Translation Interpretation</h2>
                <p>
            ...
            <section className="!mb-8">
                <h2 className="text-xl font-semibold !mb-5">Changes to These Terms and Conditions</h2>
                <p>
            ...
            <section className="!mb-8">
                ...
                <ul className="list-disc list-inside space-y-2 lg:!px-10 !mt-3">
                    <li>By email: devavrathaconsultancy@gmail.com</li>
                </ul>
            </section>
        </div>
    );
