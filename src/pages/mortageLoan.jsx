      ...
      <div className='lg:!px-20 md:!px-20 !px-10 '>
            ...
            <div className='flex justify-center items-center '>
              <div>
                ...
                <h2 className='lg:text-[50px] md:text-[35px] text-[25px] font-bold  text-black font-poppins'>
                  Your Trusted Partner  <br /> in <span className='text-[#2956A6]'>Mortgage Loan. </span>
                </h2>
        ...
        <section>
          ...
          <p className='text-[#666666] lg:text-[18px] md:text-[18px] text-[16px]  lg:leading-10 md:leading-8 leading-8  w-full  text-justify lg:!pb-5 md:!pb-5 !pb-2 '>
            ...
            This is where Devavratha consultency MyBusiness promises to support. Our financial services are aimed at helping you overcome financial constraints and realise your business goals.
          </p>

          <p className='text-[#666666] lg:text-[18px] md:text-[18px] text-[16px]  lg:leading-10 md:leading-8 leading-8  w-full  text-justify lg:!pb-5 md:!pb-5 !pb-2 '>
            To fulfil all your business endeavours; expansion, office renovation, modernisation, automation, equipment purchases, skill development, and more,
            you need capital. With Devavratha consultency Business Loans, specially designed for MSMEs, you can provide your business with the momentum it
            needs and take it to newer heights. To make things convenient, we guarantee loans at reduced turnaround time for short and long term business needs.
          </p>
        </section>
        ...
        <section>
          ...
          <div>
            ...
            <p className='text-[#666666] lg:text-[18px] md:text-[18px] text-[16px]  lg:leading-10 md:leading-8 leading-8  w-full  text-justify lg:!pb-5 md:!pb-5 !pb-2 '>
              Both residential and commercial properties* are accepted as collateral, and the money from the Devavratha consultency Loan Against Property can be used for a variety of personal or business needs.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-[#666666] lg:text-[18px] md:text-[18px] text-[16px]  lg:leading-10 md:leading-8 leading-8  w-full  text-justify lg:!pb-5 md:!pb-5 !pb-2 '>
              Remember, our Devavratha consultency Loan Against Property is an excellent debt consolidation tool.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <p className=' lg:text-[18px] md:text-[18px] text-[16px]  lg:leading-10 md:leading-8 leading-8  w-full font-bold  text-justify lg:!pb-5 md:!pb-5 !pb-2 '>
            ...
            <ul className="list-disc text-[#666666] font-normal !pl-7">
              ...
              <li>A copy of any of the following as proof of identity:
                <ul className="list-disc !pl-7">
                  <li>Employer's Card</li>
                  <li>Voter's ID</li>
                </ul>
              </li>
              <li>Latest Bank Statement/Passbook from where you can show a salary/income being credited for the previous 6 months</li>
              <li>Salary slip for the previous 6 months showing all deductions</li>
              <li>Form 16 for the previous 2 years</li>
              <li>Copies of all the property documents of the concerned property to be pledged for the loan</li>
            </ul>
          </p>
